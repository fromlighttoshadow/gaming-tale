<template>
  <q-page class="flex flex-center">
    <div class="row">
      <div class="col">
        <!-- <GameTwo /> -->
        <img src="/chapter/chapter-two-es.png" />
        <!-- <VictoryText
    ...
    <CharacterTitle label="/chapter-title/chapter-two-es.png" />
    <!-- <VictoryText /> -->

    <VictoryImg v-if="fin" label="/victory/victory-two-es.png" next="/3" />
  </q-page>
</template>

<script setup>
import CharacterTitle from "src/components/CharacterTitle.vue";
import GameTwo from "src/components/game/GameTwo.vue";
