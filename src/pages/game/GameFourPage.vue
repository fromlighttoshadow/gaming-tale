<template>
  <q-page class="flex flex-center">
    <div class="row">
      <div class="col">
        <!-- <GameTwo /> -->
        <img :src="'/game/game-four-' + languageState + '.png'" />
        <!-- <VictoryText
    ...
    <CharacterTitle
      :label="'/chapter-title/chapter-four-' + languageState + '.png'"
    />
    <!-- <VictoryText /> -->

    <VictoryImg
      v-if="fin"
      :label="'/victory/victory-four-' + languageState + '.png'"
      next="/5"
    />
  </q-page>
  <!-- <CharacterTitle:label="'Capitulo cuatro" />
  <GameFour />
  <VictoryText /> -->
</template>
